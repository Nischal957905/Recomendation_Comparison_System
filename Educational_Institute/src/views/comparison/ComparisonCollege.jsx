import { useGetComparisonCollegeQuery, useLazyGetComparisonCollegeQuery } from "../../app/api/comparisonSlice"
...
export default function ComparisonCollege() {
    ...
    const { data: optionsData } = useGetComparisonCollegeQuery({})
    const [trigger, { data }] = useLazyGetComparisonCollegeQuery()
    ...
    return(
        <main className="comparison-page">
            ...
            <section className="page-intro">
                <span className="eyebrow">College comparison</span>
                <h1>Compare colleges by experience, accessibility, rating, and total score.</h1>
                <p>Select two or three colleges to review score differences, ownership signals, accreditation details, and distance insights.</p>
            ...
            <div className="compare-controls-head">
                <div>
                    ...
                    <p>Select two colleges to start. Add one more when you need a broader shortlist.</p>
                </div>
            </div>
            <div className="compare-slot">
                <span>First college</span>
                <Autocomplete
                    disablePortal
                    id="auto-completion"
                    ...
                    renderInput={(params) => <TextField {...params} label="College" placeholder="Choose a college"/>}
                />
            </div>
            <div className="compare-slot">
                <span>Second college</span>
                <Autocomplete
                    disablePortal
                    id="auto-completion"
                    className="select-comparison"
...

            {
                ...
                <ModernComparisonChart
                    title="College score comparison"
                    metrics={[
                        ...
                        scoreObject.map((item,index) => {
                            return(
                                <div className="comparable-items" key={index}>
                                    <div>
                                        <InstitutionImage name={item.institution.name} category="college" className="comaparable-img" />
                                    </div>
